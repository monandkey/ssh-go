...
replace (
	github.com/monandkey/ssh/cmd => ./cmd
...
require (
	...
	github.com/monandkey/ssh/pkg/ssh v0.0.0-00010101000000-000000000000 // indirect
...
require (
	github.com/monandkey/ssh/cmd v0.0.0-00010101000000-000000000000
